...
class component extends React.Component {
    ...
    render() {
        return (
            <div className="module-regionCity">
                <Header />
                <div className="Province">
                    <div className="nav">
                        <span>首页</span>><span>地区站</span>><span>汕头市招标</span>
                    </div>
                    <div className="banner">
                        <div className="banner-title"><img src="./img/banner.jpg"></img>
                            <p className="title-province">SHANTOU BIDDING</p>
                            <p className="subheading-province">汕头市招标</p>
                        </div>
                    </div>
...
let RegionCity = connect(select)(component);
...
render(
    ...
    ,
    document.getElementById("regionCity")
);